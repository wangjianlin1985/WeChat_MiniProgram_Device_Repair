...
public class ApiUserInfoController {
	...
	public JsonResult list(String user_name,String name,@ModelAttribute("buildingObj") BuildingInfo buildingObj,String birthDate,String telephone,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
