				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>区域编号</td><td>区域名称</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="areaInfo_areaId_edit" class="col-md-3 text-right">区域编号:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="areaInfo_areaId_edit" name="areaInfo.areaId" class="form-control" placeholder="请输入区域编号" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
