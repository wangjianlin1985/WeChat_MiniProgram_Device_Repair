...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">宿舍报修网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>RepairMan/frontlist">维修人员</a></li>
                <li><a href="<%=basePath %>BreakType/frontlist">故障类型</a></li>
                <li><a href="<%=basePath %>BreakInfo/frontlist">故障信息</a></li>
                <li><a href="<%=basePath %>TaskInfoState/frontlist">任务状态</a></li>
