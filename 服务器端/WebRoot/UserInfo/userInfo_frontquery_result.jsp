			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>UserInfo/<%=userInfo.getUser_name() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=userInfo.getUserPhoto()%>" /></a>
			     <div class="showFields">
			     	...
			     	<div class="field">
	            		所在宿舍:<%=userInfo.getBuildingObj().getBuildingName() %>
			     	</div>
			     	<div class="field">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="userInfo_buildingObj_buildingId_edit" class="col-md-3 text-right">所在宿舍:</label>
		  	 <div class="col-md-9">
			    <select id="userInfo_buildingObj_buildingId_edit" name="userInfo.buildingObj.buildingId" class="form-control">
			    </select>
		  	 </div>
		  </div>
		  <div class="form-group">
			...
			if (userInfo) {
				...
				$.ajax({
					...
					success: function(buildingInfos,response,status) { 
						$("#userInfo_buildingObj_buildingId_edit").empty();
						var html="";
		        		$(buildingInfos).each(function(i,buildingInfo){
		        			html += "<option value='" + buildingInfo.buildingId + "'>" + buildingInfo.buildingName + "</option>";
		        		});
		        		$("#userInfo_buildingObj_buildingId_edit").html(html);
		        		$("#userInfo_buildingObj_buildingId_edit").val(userInfo.buildingObjPri);
					}
				});
